...
Using different augmentations or adding points from the same cluster as the query.
...
Implement all the negative sampling techniques from section \ref{limitations:mining} as well as compare using a momentum encoder and perhaps one of the clustering techniques from section \ref{limitations:clustering}
