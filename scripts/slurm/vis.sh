...
# salloc --account=rrg-jskelly --gres=gpu:1 --cpus-per-task=10 --mem=46000M --time=1:00:00
# salloc --account=rrg-jskelly --gres=gpu:4 --cpus-per-task=40 --mem=186000M --time=1:00:00
