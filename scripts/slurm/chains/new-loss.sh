...
bash scripts/slurm/pretrain.sh scripts/experiments/pretrain/new_loss.sh
bash scripts/slurm/run.sh scripts/experiments/s3dis/minkowski-pretrained-new-loss.sh