...
from datasets.measurements_new import SceneMeasurements, measurements_dir_name
...
@dataclass
class NewScannetPretrainDataInterface(DataInterface):
    """
    ...
    def preprocess(self, datapoint: ScannetDataPoint) -> None:
        ...
        if self.do_sensor_files_exist_in_scene(datapoint.scene_path):
            ...
            self.preprocess_measurements(datapoint, scene)

    def preprocess_measurements(
        self, datapoint: ScannetDataPoint, scene: SceneWithLabels
    ):
